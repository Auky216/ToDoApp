...
import { Plus, Trash2, ImageIcon, Circle,Star } from 'lucide-react';
...
export default function TaskUser() {
    ...
    const [favoriteTaskInput, setFavoriteTaskInput] = useState('');
                                ...
                                <div key={task.id}>
                                    <div className="group flex items-center gap-3 rounded-md px-3 py-2.5 hover:bg-white/10 transition-colors">
                                        ...
                                        <Button
                                            variant="ghost"
                                            size="icon-xs"
                                            className="opacity-0 group-hover:opacity-100 text-white/70 hover:text-yellow-400 hover:bg-white/10 transition-opacity"
                                            onClick={() => favoriteTask(task.id)}
                                        >
                                            <Star />
                                        </Button>
                                        <Button
